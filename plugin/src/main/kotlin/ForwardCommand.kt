...
import org.meowcat.mesagisto.mirai.MesagistoConfig.addressTokenRepo
import org.meowcat.mesagisto.mirai.MesagistoConfig.targetAddressMapper
...
object ForwardCommand : CompositeCommand(
   ...
   suspend fun MemberCommandSender.handleListChannel() {
      ...
      if (MesagistoConfig.addressTokenRepo.size == 0) {
         sendMessage(
            """
